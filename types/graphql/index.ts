...
export const CreateProjectDocument = gql`
    mutation CreateProject($name: String!, $description: String, $githubUrl: String, $startsAt: ISO8601DateTime, $endsAt: ISO8601DateTime, $languages: [LanguageInput!], $recruitmentNumbers: Int, $toolLink: String, $contribution: String, $ownerId: Int!) {
  createProject(
    input: {name: $name, description: $description, githubUrl: $githubUrl, startsAt: $startsAt, endsAt: $endsAt, languages: $languages, recruitmentNumbers: $recruitmentNumbers, toolLink: $toolLink, contribution: $contribution, ownerId: $ownerId}
  ) {
    project {
      id
      name
